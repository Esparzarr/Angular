// To parse this data:
//
//   import { Convert, SearchGIFReponse } from "./file";
//
//   const searchGIFReponse = Convert.toSearchGIFReponse(json);
//
// These functions will throw an error if the JSON doesn't
// match the expected interface, even if the JSON is valid.

export interface SearchGIFReponse {
    data:       Gif[];
...
export class Convert {
    public static toSearchGIFReponse(json: string): SearchGIFReponse {
        return cast(JSON.parse(json), r("SearchGIFReponse"));
    }

    public static searchGIFReponseToJson(value: SearchGIFReponse): string {
        return JSON.stringify(uncast(value, r("SearchGIFReponse")), null, 2);
    }
}
